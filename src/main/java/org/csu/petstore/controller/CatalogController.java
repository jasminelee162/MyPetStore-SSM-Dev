...
//    public CommonResponse<CategoryVO> getCategory(@PathVariable String categoryId, HttpSession session) {
...
//    public CommonResponse<List<Product>> getProductsByCategory(@PathVariable String categoryId, HttpSession session) {
//        CategoryVO categoryVO = catalogService.getCategory(categoryId);
//        session.setAttribute("category", categoryVO);
//        catalogService.setLog("category", session, categoryId);
...
//    public CommonResponse<ProductVO> getProduct(@PathVariable String productId, HttpSession session, HttpServletRequest request) {
...
//    public CommonResponse<List<Item>> getItemsByProduct(@PathVariable String productId, HttpSession session) {
//        ProductVO productVO = catalogService.getProduct(productId);
//        return CommonResponse.createForSuccess(productVO.getItemList());
//    }
//
//    @GetMapping("/items/{itemId}")
//    public CommonResponse<ItemVO> getItem(@PathVariable String itemId, HttpSession session, HttpServletRequest request) {
...
//    public CommonResponse<Integer> getItemQuantity(@PathVariable String itemId) {
//        Map<String, Integer> quantities = catalogService.getItemQuantities(List.of(itemId));
//        Integer quantity = quantities.getOrDefault(itemId, 0);
//        return CommonResponse.createForSuccess(quantity);
//    }
//
//    @GetMapping("/products/search")
//    public CommonResponse<ProductVO> searchProduct(@RequestParam String keyword, HttpSession session, HttpServletRequest request) {
//        logRequest(request, "User searched product: " + keyword);
//        List<Product> productList = catalogService.searchProductList(keyword);
//        if (!productList.isEmpty()) {
//            Product product = productList.get(0);
//            CategoryVO categoryVO = catalogService.getCategory(product.getCategoryId());
//            session.setAttribute("category", categoryVO);
//            catalogService.setLog("product", session, product.getProductId());
//
